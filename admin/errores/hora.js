/*<script type="text/javascript">
            ...
            function contador_onload(){
                ...
                timeElapsed=timeElapsed%1000;hunsElapsed=Math.floor(timeElapsed/10);
                timeElapsed=timeElapsed%10;out+=((secsElapsed<10)?"0":"")+secsElapsed+"<span class=\"dot\">.</span>";
                out+=((hunsElapsed<10)?"0":"")+hunsElapsed;document.getElementById('numbox').innerHTML=out;
            ...
            function mostrar_fecha(){
                ...
                month[10]="Noviembre";
                month[11]="Diciembre";
                var todaysDate=month[d.getUTCMonth()]+' '+d.getUTCDate()+', '+d.getUTCFullYear()+'<br>'+((d.getUTCHours()<10)?"0":"")+d.getUTCHours()+':'+((d.getUTCMinutes()<10)?"0":"")+d.getUTCMinutes()+'  GMT'+'<br>'+((d.getHours()<10)?"0":"")+d.getHours()+':'+((d.getMinutes()<10)?"0":"")+d.getMinutes()+'  hora local<br>'+'GMT  '+gmt;
            ...
            function getLogonTime(){
                var now=new Date();var ampm=(now.getHours()>=12)?" P.M.":" A.M."
                var Hours=now.getHours();Hours=((Hours>12)?Hours-12:Hours);
                var Minutes=((now.getMinutes()<10)?":0":":")+now.getMinutes();
                var Seconds=((now.getSeconds()<10)?":0":":")+now.getSeconds();
                OnTimeValue=(" "+Hours+Minutes+Seconds+" "+ampm);
            ...
            function timer(){
                if(offSeconds>=onSeconds){
                    ...
                    offMinutes-=1;logSeconds=(offSeconds+60)-onSeconds;
                }
            ...
            function doClock(){
                ...
                clockID.innerHTML='Hoy es: '+calDays[d]+", "+dt+" de "+months[m]+" del "+y+"<br>Son las: "+h+":"+mn+":"+s+" "+ap
            }
            function pad(a){
                if(a<10){
                    a="0"+a
            ...
            months=new Array(
                    "Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");calDays=new Array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado"
                    )//Reloj barra
            var H='....';
            var H=H.split('');
            var M='.....';
...
//]]>
        ...
        <input style="text-align:center;font-size:18px;padding:6px;margin:12px 0 12px 12px;" 
                       type="button" 
                       value="Ver a que hora entraste" 
                       onclick="getLogoffTime()"><br>
